...
# Thiết lập FPS, Height và Width
fps = 25  # FPS mong muốn
width = 1280  # Chiều rộng video
height = 720  # Chiều cao video


cap = cv2.VideoCapture(0)
# Thiết lập FPS, chiều rộng và chiều cao của video
...
while cap.isOpened():
    ...
    client_timestamp = datetime.now(timezone.utc).strftime('%H:%M:%S.%f')[:-3]
